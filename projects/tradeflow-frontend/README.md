...
7. Upon invocation, CD pipeline will pull the VITE\_ prefixed environment variables, build the project and deploy to the specified environment.
   For Netlify:
8. Retrieve your [Netlify Access Token](https://docs.netlify.com/cli/get-started/#obtain-a-token-in-the-netlify-ui)
9. Inside your folder run `netlify login`
10. Inside your folder run `netlify sites:create` to create a new site, obtain NETLIFY_SITE_ID from the output
11. Inside GitHub, add `NETLIFY_AUTH_TOKEN` and `NETLIFY_SITE_ID` as [secrets](https://docs.github.com/en/actions/security-guides/encrypted-secrets).
12. Define the VITE\_ prefixed environment variables in netlify environment variables under site settings.
13. Upon invocation, CD pipeline will build the project and deploy to the specified environment.
